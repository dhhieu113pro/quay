...
export const catalogPresets: CatalogPreset[] = [
  ...
  { image: "ngrok/ngrok:latest", name: "ngrok", label: "ngrok", hint: "Public HTTPS → MCP :5000  (paste NGROK_AUTHTOKEN)", ports: "4040:4040", env: "NGROK_AUTHTOKEN=", mounts: "", workdir: "/", command: "http local-coding-mcp:5000 --log=stdout", groupId: "local-coding" },
